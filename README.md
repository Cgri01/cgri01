...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Responsive and user-friendly websites focused on clean interface design and usability.</p>
    </td>
    <td width="50%">
      <h3>⚙️ Software Projects</h3>
      <p>Structured software projects developed with maintainability, clarity, and practical use in mind.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🎨 UI/UX-Oriented Interfaces</h3>
      <p>Modern layouts that prioritize readability, accessibility, and smooth user experience.</p>
    </td>
    <td width="50%">
      <h3>🤖 AI-Assisted Development</h3>
      <p>Using AI tools to support research, debugging, documentation, and faster project development.</p>
    </td>
  </tr>
</table>
...
- Improving frontend and full-stack development skills
- Building polished and practical portfolio projects
- Learning software engineering best practices
- Creating clean, readable, and maintainable code
- Using AI tools effectively and responsibly in development workflows
